...
export default function TeamAttendancePage() {
  ...
  const [dailyMetrics, setDailyMetrics] =
    useState<DailyAttendanceMetrics | null>(null);
  ...
  if (loading && !dailyMetrics) {
    return (
      <DashboardLayout>
        <PageHeader
          title="Team Attendance"
          description="Monitor your team's attendance and work hours"
                ...
                <CardContent>
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-sm font-semibold tabular-nums">
                      {dailyMetrics.attendance_rate.toFixed(0)}%
                    </p>
                  </div>
                </CardContent>
              </Card>
