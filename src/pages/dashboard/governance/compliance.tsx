 ...
 useEffect(() => {
  ...
  const mockPersonalData: PersonalDataReport[] = [
   ...
   },
   {
    ...
    fields: ["Login credentials", "Access logs", "IP addresses", "Device info"],
      ...
      <div className="grid gap-4 md:grid-cols-4">
       ...
       <Card className=" ">
        <CardHeader className="pb-3">
         ...
         <CardTitle className="text-3xl font-bold">
          {
           dataInventory.filter((d) => d.compliance_status === "compliant")
            .length
          }
         </CardTitle>
        </CardHeader>
       ...
       <Card className=" ">
        <CardHeader className="pb-3">
         ...
         <CardTitle className="text-3xl font-bold">
          {dataInventory.reduce((acc, d) => acc + d.size_mb, 0).toFixed(1)}{" "}
          MB
         </CardTitle>
        </CardHeader>
       </Card>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
               ...
               <div className="flex items-center gap-2">
                ...
                <div>
                 ...
                 <p className="font-semibold">{item.size_mb} MB</p>
                </div>
               </div>
               <div className="flex items-center gap-2">
               ...
               <div className="flex items-center gap-2">
                ...
                <div>
                 ...
                 <p className="font-semibold">
                  {format(new Date(item.last_updated), "MMM dd")}
                 </p>
                </div>
               </div>
              </div>
          ...
          {isLoading ? (
           ...
           <div className="space-y-4">
            <div className="p-4 rounded-lg bg-muted/50 border border-muted">
             ...
             <p className="text-sm text-muted-foreground">
              This report shows all categories of personal data stored in
              our HRMS system
             </p>
            </div>
              ...
              <div className="space-y-3">
               ...
               <div className="grid md:grid-cols-2 gap-4 text-sm">
                ...
                <div>
                 ...
                 <p className="text-sm">{data.retention_period}</p>
                </div>
               </div>
              </div>
             </div>
            ...
            <div className="mt-6 p-4 rounded-lg bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900">
             <p className="text-sm text-blue-900 dark:text-blue-100">
              ...
              correct, or request deletion of your personal data. Contact
              HR for any data-related requests.
             </p>
            </div>
           </div>
          )}
